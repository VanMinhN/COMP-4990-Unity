...
public class GeneticManager : MonoBehaviour
{
    ...
    public void Death(float fitness, NeurolN network)
    {
    ...
    //management method: manage gene pool
    private void RePopulate()
    {
        ...
        NeurolN[] newPopulation = PickBestPopulation();
    ...
    private void Mutate(NeurolN[] newPopulation)
    {
    ...
    private void Crossover(NeurolN[] newPopulation)
    {
        for (int i = 0; i < numberToCrossover; i += 2)
        {
            ...
            NeurolN Child1 = new NeurolN();
            NeurolN Child2 = new NeurolN();
    ...
    private NeurolN[] PickBestPopulation()
    {

        NeurolN[] newPopulation = new NeurolN[initialPopulation];
